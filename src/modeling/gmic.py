...
class GMIC(lightning.LightningModule):
    ...
    def forward(self, image):
        ...
        print(f'GMIC.forward() :: {h_crops=}; {h_crops.shape=}')
    ...
    def val_dataloader(self):
        ...
        if self.valid_dataset:
            return torchdata.DataLoader(self.valid_dataset, batch_size=self.hparams.batch_size, num_workers=8, shuffle=False)
        return None
    ...
    def test_dataloader(self):
        ...
        if self.test_dataset:
            return torchdata.DataLoader(self.test_dataset, batch_size=self.hparams.batch_size, num_workers=8, shuffle=False)
        return None

    def predict_dataloader(self):
        """Create DataLoader for Testing out of given DataSet"""
        if self.predict_dataset:
            return torchdata.DataLoader(self.predict_dataset, batch_size=1, num_workers=8, shuffle=False)
        return None
