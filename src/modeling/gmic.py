...
class GMIC(lightning.LightningModule):
    ...
    def val_dataloader(self):
        ...
        if self.dataset_valid:
            return DataLoader(self.dataset_valid, batch_size=self.hparams.batch_size, num_workers=12, shuffle=False)


    def test_dataloader(self):
        """Create DataLoader for Testing out of given DataSet"""
        if self.dataset_test:
            return DataLoader(self.dataset_test, batch_size=self.hparams.batch_size, num_workers=12, shuffle=False)
