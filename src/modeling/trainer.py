...
class GMICTrainer(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        if self.train_dataset:
            return DataLoader(self.train_dataset, batch_size=self.hparams.batch_size, num_workers=multiprocessing.cpu_count())
        return None
    ...
    def val_dataloader(self):
        ...
        if self.valid_dataset:
            return DataLoader(self.valid_dataset, batch_size=self.hparams.batch_size, num_workers=multiprocessing.cpu_count())
        return None
    ...
    def test_dataloader(self):
        ...
        if self.test_dataset:
            return DataLoader(self.test_dataset, batch_size=self.hparams.batch_size, num_workers=multiprocessing.cpu_count())
        return None