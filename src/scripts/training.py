...
if __name__ == "__main__":
    run_training(epochs=32, epoch_smote=32, undersampling_rate=0.0, augmentation_rate=0.0, smote_rate=0.0, binary=True, augment=True)
    run_training(epochs=32, epoch_smote=32, undersampling_rate=0.5, augmentation_rate=0.0, smote_rate=0.0, binary=True, augment=True)
    run_training(epochs=32, epoch_smote=16, undersampling_rate=0.0, augmentation_rate=0.0, smote_rate=0.5, binary=True, augment=True)
