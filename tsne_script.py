...
checkpoint_path = "/home/pb438//sdsHD/sd24f004/denbi/gmic/test_models/epoch=31-step=3104.ckpt"
...
def main():
    ...
    print("Running t-SNE (this may take time)...")  # ✅ t-SNE block
    ...
    plt.title("t-SNE of Feature Vectors from Used Training Images", fontsize=16)
    plt.xlabel("t-SNE Dim 1", fontsize=14)
    plt.ylabel("t-SNE Dim 2", fontsize=14)
    plt.legend(title="Classes", fontsize=12)
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("tsne_used_training_features.png", dpi=300)
    plt.show()
    print("✅ t-SNE completed. Saved as: tsne_used_training_features.png")
